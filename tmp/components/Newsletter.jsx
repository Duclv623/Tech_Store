...
const Newsletter = () => {
    return (
        <div className='flex flex-col items-center mx-4 my-36'>
            <Title title="Đăng ký nhận tin" description="Đăng ký để nhận các ưu đãi độc quyền, sản phẩm mới và thông tin nội bộ được gửi trực tiếp đến hộp thư của bạn mỗi tuần." visibleButton={false} />
